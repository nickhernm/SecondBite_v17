...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card" >
        <div class="card-header row" style="display: flex; justify-content: space-between;">
            <h2 style="flex: 1;"><%# DataBinder.Eval(Container.DataItem, "numPedido") %></h2>
    ...
    <ItemTemplate>
        ...
        <div class="card" style="position: relative">
            ...
            <div class="card-header">
                <h2><%# DataBinder.Eval(Container.DataItem, "linea") %></h2>
                <h2><%# DataBinder.Eval(Container.DataItem, "pedido") %></h2>
                <h2><%# DataBinder.Eval(Container.DataItem, "importe") %></h2>
                <h2><%# DataBinder.Eval(Container.DataItem, "cantidad") %></h2>
                <h2><%# DataBinder.Eval(Container.DataItem, "platoId") %></h2>
            ...
            <div class="card-body row">
                ...
                <p><asp:Label ID="txtContent" runat="server"></asp:Label></p>
                    <div style="position: absolute; bottom: 0px;">
                        ...
                        <div >Unidades: 2</div>
                        <h2><%# DataBinder.Eval(Container.DataItem, "plato.Id") %></h2>
                        <h2><%# DataBinder.Eval(Container.DataItem, "plato.Nombre") %></h2>
                        <h2><%# DataBinder.Eval(Container.DataItem, "plato.Alergenos") %></h2>
                        <h2><%# DataBinder.Eval(Container.DataItem, "plato.Puntuacion") %></h2>
